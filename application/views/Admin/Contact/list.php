         ...
         <div class="table-reponsive">
            <table class="table table-bordered table-hover" >
               ...
               <div class="alert alert-success">
                ...
                <?php endif;?>
               <thead>
               <form action="<?php echo admin_url('Contact')?>/setStatus" method="post" id="form_muti">
                  <div class="dropdown">
             ...
             <?php $i=1; foreach ($listTable as $value) :?>
                <tr>
                   ...
                   <th scope="row"><?= date(' d/m/Y',strtotime($value->created_at));?></th>
                   <th ><a href="<?php echo admin_url('Contact')?>/edit/<?php echo $value->id?>" class="btn btn-info btn-xs "><span class="glyphicon glyphicon-pencil"></span> Sửa</a>   </th>
                   <th onclick=" return  confirm ('Bạn Chắc chắn xóa không ?')" ><a  href="<?php echo admin_url('Contact')?>/del/<?php echo $value->id?>" class="btn btn-danger btn-xs"> <span class="glyphicon glyphicon-trash "></span> Xóa</a>  </th>
                </tr>
             <?php endforeach;?>
               <?php }else{?>
