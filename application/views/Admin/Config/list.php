            ...
            <table class="table table-bordered table-hover" >
             ...
             <?php $i=1; foreach ($menu_list as $value) :?>
                <tr>
                   ...
                   <th scope="row"><?= ($value->status == 1 ) ? 'Hiện' : 'Ẩn' ?></th>
                   <th scope="row"><?php  if ($value->type == 1){echo 'Bữa sáng';}
                   ...
                   <th onclick=" return  confirm ('Bạn Chắc chắn xóa không ?')" ><a href="<?php echo admin_url('menu')?>/del/<?php echo $value->id?>">Xóa</a>  </th>
                </tr>
             <?php endforeach;?>
               <?php }else{?>
